...
SlashCmdList["ASCBUILDSCHMIEDE"] = function(msg)
    ...
    if msg == "help" or msg == "?" then
        BS.Print("/bs - Fenster oeffnen. /bs target - Build des Ziels auslesen.")
        BS.Print("/bs gear - Gear an/aus. /bs stats - Stats an/aus.")
        BS.Print("Text markieren, Strg+C, dann in der Buildschmiede unter EINFUEGEN ablegen:")
        BS.Print(BS.SITE)
        return
    end
